# Projeto Prelúdio: Recursos Complementares
...
CSS Portal é o lar de muitos exemplos de CSS/HTML e como eles podem ser usados no design de sites. Você encontrará centenas de páginas com ferramentas, recursos e geradores para ajudar com CSS e HTML.

Endereço: [CSS Portal](https://www.cssportal.com/)
...
Real Python é uma plataforma de aprendizado online que ensina indivíduos e empresas as habilidades necessárias para trabalhar com Python no mundo real.
...
O roadmap.sh é um esforço comunitário para criar roteiros, guias e outros conteúdos educacionais para ajudar a orientar desenvolvedores a escolherem um caminho e guiarem seus aprendizados.
...
## Canais no Youtube com dicas e tutoriais interessantes

### Coding2GO

Canal onde você aprende os conceitos de programação por meio de tutoriais rápidos e precisos sobre HTML, CSS e JavaScript.

Endereço: [Coding2GO](https://www.youtube.com/@coding2go/videos)

### Optimistic Web

Tutoriais fáceis de seguir que abrangem HTML, CSS, JavaScript e design responsivo, com simplicidade e clareza em mente. Sem jargões ou conversas técnicas confusas – apenas orientações diretas e amigáveis em cada etapa da sua jornada no desenvolvimento web, desde dicas para iniciantes até truques avançados.

Endereço: [Optimistic Web](https://www.youtube.com/@OptimisticWeb/videos)

### Philomatics

Dicas e tutoriais de Git.
...
Um jogo onde você ajuda Froggy e seus amigos escrevendo código CSS! Guie o sapinho até o vitória-régia usando a propriedade Flexbox.
